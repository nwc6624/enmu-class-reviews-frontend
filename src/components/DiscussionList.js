      ...
      <Box my={4}>
        ...
        <Box my={4}>
          {discussions.map((discussion) => (
            <Paper key={discussion.id} my={2} p={2} elevation={3} style={{ marginBottom: '16px', padding: '16px' }}>
              ...
              <Button variant="contained" color="primary" component={Link} to={`/discussion/${discussion.id}`} style={{ marginTop: '10px' }}>
                View Comments
              </Button>
            </Paper>
          ))}
